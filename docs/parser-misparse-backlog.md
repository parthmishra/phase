...
- **Distinct cards implicated:** 4717
- **Total card appearances across root causes:** 4750 (a card may appear under more than one root cause when it exhibits multiple distinct misparses)
